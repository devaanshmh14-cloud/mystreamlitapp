...
st.markdown(
    '<h1 class="float-title">English</h1>',
    unsafe_allow_html=True
)
st.write("Welcome! Here you will find all the material needed for your english exam. All  the resources uploaded are free to access and use. Just click on the buttons to find the resources you need! If you have any suggestions for resources to add, please let me know in the contact form on the home page. Thanks for visiting!")
...
st.markdown(
    '<h2 class="float-title">English Exam Boards</h2>',
    unsafe_allow_html=True
)
if st.button("AQA",width=110000):
    st.switch_page("pages/AQA_English.py")